<h2><a href="https://leetcode.com/problems/sell-diminishing-valued-colored-balls">Sell Diminishing-Valued Colored Balls</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You have an <code>inventory</code> of different colored balls, and there is a customer that wants <code>orders</code> balls of <strong>any</strong> color.</p>
